...
CATS = {
    ...
    'rl':       ('🎮 REINFORCEMENT LEARNING',  '#16a34a'),
...
projects = [
    ...
    ('rl_snake_dt',          'rl',       'Snake AI — Decision Tree',      'Snake agent using a decision tree to choose its next move.',                      ['GitHub'],  None),
    ('rl_snake_ga',          'rl',       'Snake AI — Genetic Algorithm',  'Snake agent evolved through generations with a genetic algorithm.',               ['GitHub'],  None),
    ('rl_driving_ga',        'rl',       'Driving AI — Genetic Algorithm','Self-driving car trained with a genetic algorithm.',                              ['GitHub'],  None),
    ('rl_walking_ga',        'rl',       'Walking AI — Genetic Algorithm','AI learning to walk using Box2D physics engine and genetic algorithm.',           ['GitHub'],  None),
    ('rl_q_learning',        'rl',       'Q-Learning',                    'Agent finding the optimal path in a grid world using Q-Learning.',                ['GitHub'],  None),
    ('rl_snake_dql',         'rl',       'Snake AI — Deep Q-Learning',    'Snake agent trained with a Deep Q-Network (DQN).',                               ['GitHub'],  None),
    ('rl_driving_dql',       'rl',       'Driving AI — Deep Q-Learning',  'Self-driving car trained with a Deep Q-Network (DQN).',                          ['GitHub'],  None),
    ('rl_snake_ppo',         'rl',       'Snake AI — PPO',                'Snake agent trained with Proximal Policy Optimization.',                          ['GitHub'],  None),
    ('rl_sc2',               'rl',       'StarCraft 2 AI — PPO + VLM',   'SC2 AI combining Vision-Language Model with PPO reinforcement learning.',         ['GitHub'],  None),
    ('rl_unity_move',        'rl',       'Unity AI — Move',               'Unity agent learning to move towards a target using ML-Agents.',                  ['GitHub'],  None),
    ('rl_unity_greedy',      'rl',       'Unity AI — Greedy',             'Unity agent learning to collect rewards greedily using ML-Agents.',               ['GitHub'],  None),
    ('rl_unity_drive',       'rl',       'Unity AI — Drive',              'Unity agent learning to drive through a maze using ML-Agents.',                   ['GitHub'],  None),
