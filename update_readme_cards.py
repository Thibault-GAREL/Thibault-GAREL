...
FEATURED_SECTIONS = [
    ('<h3 align="center">📝 Language Models</h3>', [
        ...
        ('lm_modern_llm',         'lm_modern_llm.png',      GH + 'LLMs_modern_from_scratch', 'Modern LLM'),
        ('lm_rag',                'lm_rag.webp',             GH + 'RAG_pdf',                  'RAG'),
        ('lm_clip',               'lm_clip_embedding.png',  GH + 'CLIP_Embedding_Tools',     'CLIP'),
        ('lm_robot_local_llm',    'lm_robot_local_llm.webp', GH + 'Robot_Controlled_by_Local_LLM', 'Robot Controlled by Local LLM'),
    ]),
    ...
    ('<h3 align="center">🧠 Neural Networks</h3>', [
        ('neural_scratch', 'neural_net_from_scratch.webp', GH + 'Neural_Network_from_Scratch', 'Neural Networks'),
        ('neural_asr',     'neural_asr.png',              GH + 'Speech_recognition',          'ASR'),
    ]),
    ('<h3 align="center">🎮 Reinforcement Learning</h3>\n\n---\n\n#### **🌳 Decision Tree**', [
        ('rl_snake_dt', 'rl_snake_decision_tree.webp', GH + 'AI_snake_decision_tree_version', 'Snake DT'),
    ]),
    ('#### **🧬 Genetic Algorithm**', [
        ('rl_snake_ga',   'rl_snake_genetic.webp',   GH + 'AI_snake_genetic_version',    'Snake GA'),
        ('rl_driving_ga', 'rl_driving_genetic.webp', GH + 'AI_driving_genetic_version',  'Driving GA'),
        ('rl_walking_ga', 'rl_walking_genetic.png', GH + 'test_box2D_pygame',           'Walking GA'),
    ]),
    ('#### **📈 Q-Learning**', [
        ('rl_q_learning',  'rl_q_learning.webp',  GH + 'Q-Learning',            'Q-Learning'),
        ('rl_snake_dql',   'rl_snake_dql.webp',   GH + 'AI_snake_DQN_version',  'Snake DQL'),
        ('rl_driving_dql', 'rl_driving_dql.webp', GH + 'AI_driving_DQN_version', 'Driving DQL'),
    ]),
    ('#### **🎯 PPO**', [
        ('rl_snake_ppo', 'rl_snake_ppo.webp', GH + 'AI_snake_PPO_version', 'Snake PPO'),
        ('rl_sc2',       'rl_starcraft2.webp', GH + 'AI-StarCraft2-VLM-RL', 'SC2 AI'),
    ]),
    ('#### **🌍 World Model**', [
        ('rl_snake_wm', 'rl_snake_world_model.webp', GH + 'AI_snake_world_model_version', 'Snake AI - World Model'),
    ]),
    ('#### **🎮 Unity ML-Agents**', [
        ('rl_unity_move',   'rl_unity_move.webp',   GH + 'Unity_move',   'Unity Move'),
        ('rl_unity_greedy', 'rl_unity_greedy.webp', GH + 'Unity_greedy', 'Unity Greedy'),
        ('rl_unity_drive',  'rl_unity_drive.webp',  GH + 'Unity_drive',  'Unity Drive'),
    ]),
    ('<h3 align="center">🕹️ Games</h3>', [
        ('game_snake',    'game_snake.webp',         GH + 'snake_game',              'Snake Game'),
        ('game_driving',  'game_driving.webp',       GH + 'driving_game',            'Driving Game'),
        ('game_sandbox',  'game_human_sandbox.webp', GH + 'human_sandbox',           'Human Sandbox'),
    ...
    ('<h3 align="center">⚙️ Physics Simulation</h3>', [
        ('physics_gravity',            'physics_gravity.webp',              GH + 'gravity_simulation',                  'Gravity'),
        ('physics_attraction',         'physics_attraction_repulsion.webp', GH + 'Attraction_repulsion',                'Attraction'),
        ('physics_muscular',           'physics_muscular_simulation.png',  GH + '2D-Muscular-Simulation',              'Muscular'),
        ('physics_general_relativity', 'physics_general_relativity.webp',   GH + 'simulation_gravity-general_relativity', 'Gravity & Relativity'),
    ]),
